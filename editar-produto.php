...
$produto = $produtoRepository->searchById($_GET['id']);
...
<main>
    ...
    <section class="container-form">
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="container-radio">
                <div>
                    ...
                    <input type="radio" id="cafe" name="tipo"
                           value="Café" <?= $produto->getTipo() == "Café" ? "checked" : "" ?> >
                </div>
                <div>
            ...
            <input type="file" name="imagem" accept="image/*" id="imagem" value="<?= $produto->getImagemFormatada() ?>"
